...
public class Q245ShortestWordDistanceIII {
    ...
    /**
     * Solution:
     * Depends on Q243ShortestWordDistance, diff is a diff way to calculate the distance when word1.equals(word2), need to calculate i - index1, and then update index1 to i
