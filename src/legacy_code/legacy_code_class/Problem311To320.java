...
[
  ...
  [7]
     ...
     */
    /*
    Approach 1: depth_first_search, list separate by the relative order of left and right node, which when goto left, index--, goto right index++
 ...
 4  01   7
   ...
   /  \
   5   2
   in this case, for depth_first_search, it was 2 -> ... -> 8, but vertical order it's 8 -> 2, separate node by level
