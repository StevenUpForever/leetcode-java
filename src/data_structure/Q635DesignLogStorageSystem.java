...
public class Q635DesignLogStorageSystem {
    ...
    /*
    Solution:
    Add [id, timestamp] array to list,
    when retrieve, find current timestamp and compare if within the scope, if so, add to result list
     */
